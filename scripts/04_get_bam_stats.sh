...
#SBATCH --output=/maps/projects/course_1/scratch/group7/group-project-group-7/week18-preprocessing/02_preprocessing/gut_adult/ERR2641635/%x_%j.out
#SBATCH --error=/maps/projects/course_1/scratch/group7/group-project-group-7/week18-preprocessing/02_preprocessing/gut_adult/ERR2641635/%x_%j.err
#SBATCH --ntasks=1
