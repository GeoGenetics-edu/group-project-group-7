...
#SBATCH --output=/maps/projects/course_1/scratch/group7/group-project-group-7/week18-preprocessing/06_quality_checkm2/logs/%x_%j.out
#SBATCH --error=/maps/projects/course_1/scratch/group7/group-project-group-7/week18-preprocessing/06_quality_checkm2/logs/%x_%j.err
#SBATCH --ntasks=1
