...
#SBATCH --output=/maps/projects/course_1/scratch/group7/group-project-group-7/week19-mags/10_annotation_cazymes/logs/dbcan_summary_%j.out
#SBATCH --error=/maps/projects/course_1/scratch/group7/group-project-group-7/week19-mags/10_annotation_cazymes/logs/dbcan_summary_%j.err
...
# ---- PATHS ----
DBCAN_DIR="/maps/projects/course_1/scratch/group7/group-project-group-7/week19-mags/10_annotation_cazymes"
GTDBTK_FILE="/maps/projects/course_1/scratch/group7/group-project-group-7/week18-preprocessing/08_taxa_gtdbtk/gtdbtk.bac120.summary.tsv"
